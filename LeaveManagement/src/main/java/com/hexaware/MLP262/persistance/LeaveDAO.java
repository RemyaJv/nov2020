...
public interface LeaveDAO {
    ...
    @SqlUpdate("INSERT INTO LEAVEMANAGEMENT(Leave_Id,Number_Of_Days ,Employee_Id,Start_Date,End_Date,Leave_Type,
    Leave_Status,Leave_Reason) VALUES(:leaveId,:numberOfDays,:empId,:startDate,:endDate,:leaveType,:leaveStatus,:leaveReason)")
    int insertAgent(@BindBean Agent agent);
